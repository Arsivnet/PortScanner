...
# Template: app
# Command: /usr/bin/qmake -o Makefile PortScanner.pro
#############################################################################
...
DISTDIR = /home/arsivnet/projects/qtprojects/PortScanner/.tmp/PortScanner1.0.0
LINK          = g++
...
Makefile: PortScanner.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/lex.prf \
		PortScanner.pro
	$(QMAKE) -o Makefile PortScanner.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents Scanner.cpp $(DISTDIR)/
